  ...
  return (
    <section
      ...
      <div className="container ">
        <motion.div className="border border-white/15 py-24 rounded-xl overflow-hidden relative"
          style={{
        ...
        >
          <div
            ...
            className="absolute inset-0 bg-[rgba(74,32,138)] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_50%_35%,black,transparent)]"
            style={{
