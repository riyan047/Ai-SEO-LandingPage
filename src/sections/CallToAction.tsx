...
import { motion, animate, useTransform, useScroll, useMotionTemplate, useMotionValue } from 'framer-motion';
...
const useRelativeMousePosition = (to: RefObject<HTMLElement>) => {
  ...
  const updateMousePosition = (e:MouseEvent) => {
    ...
    mouseX.set(e.x - rect.x);
    mouseY.set(e.y - rect.y);
  }
  ...
  return (
    <section
      ...
      <div className="container ">
        ...
        >
          <div
            className="absolute inset-0 bg-[rgba(74,32,138)] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_50%_35%,black,transparent)] group-hover:opacity-0 transition duration-700"
            style={{
