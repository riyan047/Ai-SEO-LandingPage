  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] border border-dashed border-white/20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      </motion.div>
      {/* Ring 3 */}
      <motion.div
        style={{
